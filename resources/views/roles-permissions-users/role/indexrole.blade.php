            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    ...
                    <div class="card-header mt-3">
                        <h1 style="color: rgb(103, 101, 101)">Roles</h1>
                    </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @can('create role')
                                        <a class="btn btn-warning mx-2" href="{{ url('roles/'.$role->id.'/give-permissions') }}">
                                            <svg class="w-5 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M11 9V5H9v4H5v2h4v4h2v-4h4V9h-4zm-1 11a10 10 0 1 1 0-20 10 10 0 0 1 0 20z"></path></svg>
                                        </a>
                                        @endcan


                                        @can('update role')
                                        <a class="btn btn-primary mx-2" href="{{ url('roles/'.$role->id.'/edit') }}">
                                        ...
                                        @can('delete role')
                                        <a class="btn btn-danger mx-2" href="{{ url('roles/'.$role->id.'/delete') }}">
