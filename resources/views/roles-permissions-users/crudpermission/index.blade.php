            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    ...
                    <div class="card-header mt-3">
                        <h1 style="color: rgb(103, 101, 101)">Permission</h1>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary mx-2" href="{{ url('permissions/'.$permission->id.'/edit') }}">
                                        ...
                                        <a class="btn btn-danger mx-2" href="{{ url('permissions/'.$permission->id.'/delete') }}">
